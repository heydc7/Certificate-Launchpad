...
emailID = "abc@gmail.com"  # ADD MAIL ID
pwd = "abc@3"  # ADD PASSWORD
subject = "🥳 Thank You For Attending! Here is your Certificate 🎉"  # EMAIL SUBJECT
body = """Hi!\n\nThanks for your active participation in our webinar on "All About Git, GitHub & Open Source" Organized by Dhanraj. So now your wait is over and here is your certificate of participation in the webinar.\n\nAlso, don't forget to tag on LinkedIn with your certificate. we are happy to see you there!\n\nDhanraj: https://www.linkedin.com/in/dhanrajdc7/"""
...
def makeCertificate(name):
    img = Image.open("template.png") # CERTIFICATE TEMPLATE
    img.load()
    draw = ImageDraw.Draw(img)

    # Load font
    font = ImageFont.truetype("OpenSans-Bold.ttf", 96)
    ...
    if name != "":
        ...
        draw.text((811, 883), shortTxt, (0, 0, 0), font=font) # POSITION OF NAME TEXT (Check README FOR TUTORIAL)
    else:
        return -1
